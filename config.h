...
static const Rule rules[] = {
	...
	RULE(.instance = "htop", .isfloating = 1)
	RULE(.instance = "nmtui", .isfloating = 1)
	RULE(.instance = "ikhal", .isfloating = 1)
...
/* layout(s) */
static const float mfact     = 0.50; /* factor of master area size [0.05..0.95]. Default: 0.55 */
